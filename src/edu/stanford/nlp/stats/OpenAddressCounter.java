...
public final class OpenAddressCounter<E> extends AbstractCounter<E> implements Serializable {
  ...
  public OpenAddressCounter() {
    this(Hash.DEFAULT_LOAD_FACTOR);
  }

  public OpenAddressCounter(float loadFactor) {
    this(Hash.DEFAULT_INITIAL_SIZE, loadFactor);
  }

  public OpenAddressCounter(int initialCapacity, float loadFactor) {
    map = new AdjustableObject2DoubleOpenHashMap<E>(initialCapacity, loadFactor);
  }
